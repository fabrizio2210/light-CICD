<template>
    <div>
        ...
        <span v-if="projectsettings.error" class="text-danger">ERROR: {{projectsettings.error}}</span>
...
export default {
    ...
    methods: {
        handleSubmit (settingname) {
            ...
            if (settingname) {
                dispatch('projectsettings/updating', { project_id, settingname, settingvalue });
            }
        }
    },
    created () {
